    ...
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <header className="sticky top-0 z-10 bg-background/80 backdrop-blur-sm border-b border-border py-4 px-4 md:px-6">
        <div className="container mx-auto flex justify-between items-center">
          <h1 className="text-2xl font-bold text-foreground">Available Games</h1>
          <Button 
            variant="outline" 
            size="sm" 
      ...
      <div className="flex flex-1 container mx-auto">
        ...
        <div className={`fixed inset-y-0 right-0 transform ${showMobileSidebar ? 'translate-x-0' : 'translate-x-full'} md:translate-x-0 md:static transition-transform duration-300 ease-in-out z-20 md:z-0`}>
